...
import com.example.diet.converters.RecipeCommandToRecipe;
import com.example.diet.converters.RecipeToRecipeCommand;
...
public class RecipeServiceImpl implements RecipeService {
    ...
    public Recipe findById(Long l) {
        ...
        if (!recipeOptional.isPresent()) {
            ...
            throw new NotFoundException ("Recipe Not Found. For ID value: " + l.toString()); // works with webjars
        }
